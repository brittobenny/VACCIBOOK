...
<head>
    ...
    <title>Welcome to Vaccibook</title>
    ...
    <style>
        * {
        ...
        .loading-bar {
            ...
            border-radius: 10px;
            width: 0%;
            animation: loadingProgress 3.8s ease-in-out forwards;
...
<body>
    ...
    <div class="preloader-container">
        ...
        <div class="parent-name"><?php echo htmlspecialchars($pname); ?>!</div>
        <div class="quote">
            "Prevention is better than cure. Protect your loved ones with timely vaccinations."
        </div>
        <div class="loader">
